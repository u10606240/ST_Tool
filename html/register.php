   ...
   <div class="box">
	  ...
	  <form class="form" method="POST">
		  ...
		  <div class="button login">
			 <button type="submit" id="login-button" onclick="insertUser()"><span>Create Account</span> <i class="fa fa-check"></i></button>
		  </div>
	  </form>
		  <div class="button login">
			 <button onclick="window.location.href='user_list.php';"><span>View all users</span> <i class="fa fa-check"></i></button>
		  </div>	  
		  <div class="button login">
...
while($a = mysqli_fetch_array($connectd)){
	if($name != $a['username']){
		...
		$flag = false;
		echo "user has already siged up before";
		break;
	}
}
if((!empty($name))&&(!empty($pass))&&(!empty($birth))&&($flag)){

	$sql = "insert into users (username,password,birthday,login_count) VALUES ('$name', '$pass', '$birth',0)";
